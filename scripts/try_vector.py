...
def main() -> int:
    ...
    for path in args.pdfs:
        ...
        walls, openings, region = extract_walls(page)
        ...
        for o in openings:
            a = (int(round((o.start[0] - x0) * s)), int(round((o.start[1] - y0) * s)))
            b = (int(round((o.end[0] - x0) * s)), int(round((o.end[1] - y0) * s)))
            cv2.line(img, a, b, (30, 180, 30) if o.type == "door" else (30, 60, 220), 6)
